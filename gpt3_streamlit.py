...
# def predict_next_words(prompt, engine, num_words):
...
#         temperature=0.5,
#     )
#     next_words = response.choices[0].text.strip()
#     return next_words

# # Streamlit app
# st.title("GPT-3 Next Word(s) Prediction")
# prompt = st.text_input("Enter a prompt:")
# num_words = st.slider("Number of words to predict:", 1, 10)

# if prompt:
#     engines = ["davinci", "davinci-codex", "curie", "babbage", "ada"]
#     st.header("Predictions")

#     for engine in engines:
#         next_words = predict_next_words(prompt, engine, num_words)
#         st.write(f"Next {num_words} word(s) ({engine}): {next_words}")
...
# # Streamlit app
# st.title("GPT-3 Stock Analysis and Insights")
# stock_name = st.text_input("Enter a stock name (e.g., Apple, Tesla, Amazon):")

# if stock_name:
#     engines = ["davinci", "davinci-codex", "curie", "babbage", "ada"]
#     st.header("Stock Analysis and Insights")

#     for engine in engines:
#         stock_insights = generate_stock_insights(stock_name, engine)
#         st.write(f"Insights ({engine}): {stock_insights}")